...
# %%
design_path = r'./Inputs/danA.fa'
score_path = r'./NCM3722.fasta'
Cas_species = 'AsCas12f'
...
# %%
casOfFinderPath = r'./cas-offinder'
...
search_cmd = f'{casOfFinderPath} {search_file} G0 {search_outPutFile}'
...
score_cmd = f'{casOfFinderPath} {score_file_path} G0 {score_outPutFile}'
